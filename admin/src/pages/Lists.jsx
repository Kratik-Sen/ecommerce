      ...
      <div className='w-[100%] h-[100%] flex items-center justify-start'>
        ...
        <div className='w-[82%] h-[100%] lg:ml-[320px] md:ml-[230px] mt-[70px] flex flex-col gap-[30px] overflow-x-hidden py-[50px] ml-[100px]'>
...

          {
            list?.length > 0 ? (
              list.map((item,index)=>(
                <div className='w-[90%] md:h-[120px] h-[90px] bg-[#c9d0ca] rounded-xl flex items-center justify-start gap-[5px] md:gap-[30px] p-[10px] md:px-[30px]' key={index}>
                  ...
                  <div className='w-[90%] h-[80%] flex flex-col items-start justify-center gap-[2px]'>
                    ...
                    <div className='w-[100%] md:text-[20px] text-[15px] text-[#2f6f4e]'>{item.name}</div>
                     <div className='md:text-[17px] text-[15px] text-[#4f8f67]'>{item.category}</div>
            ...
            : (
              <div className='text-[#1f2a24] text-lg'>No products available.</div>
            )
          }
        </div>
