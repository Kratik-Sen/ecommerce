  ...
  return (
    <div className='w-[100vw] h-[100vh] bg-[linear-gradient(135deg,#f8f4e8_0%,#e9efe4_52%,#c7d1c8_100%)] text-[#1f2a24] flex flex-col items-center justify-start'>
       ...
       <div className='w-[100%] h-[100px] flex items-center justify-center flex-col gap-[10px]'>
           ...
           <span className='text-[16px]'>Welcome to HD Traders, Apply to Admin Login</span>
   
       </div>
       <div className='max-w-[600px] w-[90%] h-[400px] bg-[#fffaf0cc] border-[1px] border-[#b8c0ba] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center '>
           <form action="" onSubmit={AdminLogin} className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
               ...
               <div className='w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px]  relative'>
                    ...
                    <input type="text" className='w-[100%] h-[50px] border-[2px] border-[#b8c0ba] backdrop:blur-sm rounded-lg shadow-lg bg-transparent placeholder-[#6d766f] px-[20px] font-semibold' placeholder='Email' required  onChange={(e)=>setEmail(e.target.value)} value={email}/>
                     ...
                     <button className='w-[100%] h-[50px] bg-[#b7e4c7] rounded-lg flex items-center justify-center mt-[20px] text-[17px] font-semibold'>Login</button>
